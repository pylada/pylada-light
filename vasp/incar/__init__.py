...
class Incar(object):
    ...
    def __setattr__(self, name, value):
        ...
        if isinstance(value, SpecialVaspParam):
            ...
            self.special[name].value = value
        else:
            super(Incar, self).__setattr__(name, value)
    ...
    def __delattr__(self, name):
        ...
        if name in self.__dict__:
            ...
            return self.special.pop(name).value
    ...
    def symmetries(self):
        """ Type of symmetry used in the calculation.
            ...
            symmetry operation. 
        """
        if self.isym is None and self.symprec is None:
            return True
        if self.isym is None:
            return self.symprec
        if self.isym == 0:
            return False
    ...
    def symmetries(self, value):
        if value is None:
            ...
            raise ValueError("Uknown value when setting symmetries ({0}).".format(value))
