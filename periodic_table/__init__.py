...
K = Element(**{'mulliken_jaffe': 0.72999999999999998, 'single_bond_radius': array(196.0) * pm, 'pauling': 0.81999999999999995, 'molar_volume': array(45.939999999999998) * cm**3 / mol, 'bulk_modulus': array(3.1000000000000001) * GPa, 'sound_velocity': array(2000.0) * m / s, 'sanderson': 0.45000000000000001, 'atomic_weight': 39.098300000000002, 'critical_temperature': array(2223.0) * Kelvin, 'melting_point': array(336.52999999999997) * Kelvin, 'allen': 0.73399999999999999, 'orbital_radii': (array(0.81493296345999999) * angstrom, array(1.1377310853499998) * angstrom, array(0.19579558212999998) * angstrom), 'thermal_conductivity': array(100.0) * Watt / (m * Kelvin), 'ionization_energies': [array(418800.0) * J / mol, array(3052000.0) * J / mol, array(4420000.0) * J / mol, array(5877000.0) * J / mol, array(7975000.0) * J / mol, array(9590000.0) * J / mol, array(11343000.0) * J / mol, array(14944000.0) * J / mol, array(
...
Rn = Element(**{'mulliken_jaffe': 2.5899999999999999, 'electron_affinity': array(0.0) * J / mol, 'single_bond_radius': array(142.0) * pm, 'name': 'Radon', 'thermal_conductivity': array(0.0036099999999999999) * Watt / (m * Kelvin), 'atomic_number': 86, 'double_bond_radius': array(145.0) * pm, 'molar_volume': array(50.5) * cm**3 / mol, 'covalent_radius': array(150.0) * pm, 'atomization': array(0.0) * J / mol, 'boiling_point': array(211.30000000000001)
                * Kelvin, 'fusion': array(3000.0) * J / mol, 'atomic_weight': 222.0, 'critical_temperature': array(377.0) * Kelvin, 'ionization_energies': [array(1037000.0) * J / mol], 'triple_bond_radius': array(133.0) * pm, 'melting_point': array(202.0) * Kelvin, 'vaporization': array(17000.0) * J / mol, 'orbital_radii': (array(0.44450888915999998) * angstrom, array(0.49742661405999994) * angstrom, array(0.214316785845) * angstrom), 'symbol': 'Rn'})
"""
...
Fr = Element(**{'mulliken_jaffe': 0.68000000000000005, 'single_bond_radius': array(223.0) * pm, 'pauling': 0.69999999999999996, 'atomic_number': 87, 'double_bond_radius': array(218.0) * pm, 'symbol': 'Fr', 'covalent_radius': array(260.0) * pm, 'atomization': array(64000.0)
                * J / mol, 'allred_rochow': 0.85999999999999999, 'fusion': array(2000.0) * J / mol, 'atomic_weight': 223.0, 'ionization_energies': [array(380000.0) * J / mol], 'melting_point': array(300.0) * Kelvin, 'vaporization': array(65000.0) * J / mol, 'name': 'Francium'})
"""
...
Pa = Element(**{'single_bond_radius': array(169.0) * pm, 'pauling': 1.5, 'thermal_conductivity': array(47.0) * Watt / (m * Kelvin), 'atomic_number': 91, 'double_bond_radius': array(138.0) * pm, 'molar_volume': array(15.18) * cm**3 / mol, 'density': array(15.369999999999999) * g * cm**3, 'covalent_radius': array(200.0) * pm, 'atomization': array(607000.0) * J / mol,
                'atomic_radius': array(180.0) * pm, 'allred_rochow': 1.1399999999999999, 'fusion': array(15000.0) * J / mol, 'atomic_weight': 231.03587999999999, 'ionization_energies': [array(568000.0) * J / mol], 'triple_bond_radius': array(129.0) * pm, 'melting_point': array(1841.0) * Kelvin, 'vaporization': array(470000.0) * J / mol, 'symbol': 'Pa', 'name': 'Protactinium'})
"""
...
Np = Element(**{'single_bond_radius': array(171.0) * pm, 'pauling': 1.3600000000000001, 'thermal_conductivity': array(6.0) * Watt / (m * Kelvin), 'atomic_number': 93, 'double_bond_radius': array(136.0) * pm, 'molar_volume': array(11.59) * cm**3 / mol, 'density': array(20.449999999999999) * g * cm**3, 'covalent_radius': array(190.0) * pm, 'ionization_energies': [
             array(604500.0) * J / mol], 'atomic_radius': array(175.0) * pm, 'boiling_point': array(4273.0) * Kelvin, 'fusion': array(10000.0) * J / mol, 'atomic_weight': 237.0, 'allred_rochow': 1.22, 'triple_bond_radius': array(116.0) * pm, 'melting_point': array(910.0) * Kelvin, 'vaporization': array(335000.0) * J / mol, 'symbol': 'Np', 'name': 'Neptunium'})
"""
...
Am = Element(**{'single_bond_radius': array(166.0) * pm, 'pauling': 1.3, 'thermal_conductivity': array(10.0) * Watt / (m * Kelvin), 'atomic_number': 95, 'double_bond_radius': array(135.0) * pm, 'molar_volume': array(17.629999999999999) * cm**3 / mol, 'covalent_radius': array(180.0)
                * pm, 'ionization_energies': [array(578000.0) * J / mol], 'atomic_radius': array(175.0) * pm, 'boiling_point': array(2880.0) * Kelvin, 'atomic_weight': 243.0, 'allred_rochow': 1.2, 'melting_point': array(1449.0) * Kelvin, 'symbol': 'Am', 'name': 'Americium'})
"""
...
Cm = Element(**{'single_bond_radius': array(166.0) * pm, 'pauling': 1.3, 'thermal_conductivity': array(8.8000000000000007) * Watt / (m * Kelvin), 'atomic_number': 96, 'double_bond_radius': array(136.0) * pm, 'molar_volume': array(18.050000000000001) * cm**3 / mol, 'density': array(13.51) * g * cm **
                3, 'covalent_radius': array(169.0) * pm, 'ionization_energies': [array(581000.0) * J / mol], 'boiling_point': array(3383.0) * Kelvin, 'atomic_weight': 247.0, 'allred_rochow': 1.2, 'melting_point': array(1613.0) * Kelvin, 'vaporization': array(320000.0) * J / mol, 'symbol': 'Cm', 'name': 'Curium'})
"""
...
Bk = Element(**{'single_bond_radius': array(168.0) * pm, 'pauling': 1.3, 'thermal_conductivity': array(10.0) * Watt / (m * Kelvin), 'atomic_number': 97, 'molar_volume': array(16.84) * cm**3 / mol, 'density': array(14.779999999999999)
                * g * cm**3, 'double_bond_radius': array(139.0) * pm, 'ionization_energies': [array(601000.0) * J / mol], 'atomic_weight': 247.0, 'allred_rochow': 1.2, 'melting_point': array(1259.0) * Kelvin, 'symbol': 'Bk', 'name': 'Berkelium'})
"""
...
Cf = Element(**{'single_bond_radius': array(168.0) * pm, 'pauling': 1.3, 'density': array(15.1) * g * cm**3, 'atomic_number': 98, 'molar_volume': array(16.5) * cm**3 / mol, 'double_bond_radius': array(140.0)
                * pm, 'ionization_energies': [array(608000.0) * J / mol], 'atomic_weight': 251.0, 'allred_rochow': 1.2, 'melting_point': array(1173.0) * Kelvin, 'symbol': 'Cf', 'name': 'Californium'})
"""
...
Es = Element(**{'single_bond_radius': array(165.0) * pm, 'pauling': 1.3, 'atomic_number': 99, 'molar_volume': array(28.52) * cm**3 / mol, 'double_bond_radius': array(140.0) * pm,
                'ionization_energies': [array(619000.0) * J / mol], 'atomic_weight': 252.0, 'allred_rochow': 1.2, 'melting_point': array(1133.0) * Kelvin, 'symbol': 'Es', 'name': 'Einsteinium'})
"""
...
Fm = Element(**{'single_bond_radius': array(167.0) * pm, 'pauling': 1.3, 'atomic_number': 100, 'symbol': 'Fm', 'ionization_energies': [
             array(627000.0) * J / mol], 'atomic_weight': 257.0, 'allred_rochow': 1.2, 'melting_point': array(1800.0) * Kelvin, 'name': 'Fermium'})
"""
...
Md = Element(**{'single_bond_radius': array(173.0) * pm, 'pauling': 1.3, 'atomic_number': 101, 'symbol': 'Md', 'double_bond_radius': array(139.0) * pm,
                'ionization_energies': [array(635000.0) * J / mol], 'atomic_weight': 258.0, 'allred_rochow': 1.2, 'melting_point': array(1100.0) * Kelvin, 'name': 'Mendelevium'})
"""
...
No = Element(**{'single_bond_radius': array(176.0) * pm, 'pauling': 1.3, 'atomic_number': 102, 'symbol': 'No', 'ionization_energies': [
             array(642000.0) * J / mol], 'atomic_weight': 259.0, 'allred_rochow': 1.2, 'melting_point': array(1100.0) * Kelvin, 'name': 'Nobelium'})
"""
...
Lr = Element(**{'single_bond_radius': array(161.0) * pm, 'name': 'Lawrencium', 'atomic_number': 103, 'symbol': 'Lr',
                'double_bond_radius': array(141.0) * pm, 'atomic_weight': 262.0, 'melting_point': array(1900.0) * Kelvin})
"""
...
Rf = Element(**{'single_bond_radius': array(157.0) * pm, 'name': 'Rutherfordium', 'atomic_number': 104, 'symbol': 'Rf',
                'double_bond_radius': array(140.0) * pm, 'atomic_weight': 267.0, 'triple_bond_radius': array(131.0) * pm})
"""
...
Db = Element(**{'single_bond_radius': array(149.0) * pm, 'name': 'Dubnium', 'atomic_number': 105, 'symbol': 'Db',
                'double_bond_radius': array(136.0) * pm, 'atomic_weight': 268.0, 'triple_bond_radius': array(126.0) * pm})
"""
...
Sg = Element(**{'single_bond_radius': array(143.0) * pm, 'name': 'Seaborgium', 'atomic_number': 106, 'symbol': 'Sg',
                'double_bond_radius': array(128.0) * pm, 'atomic_weight': 271.0, 'triple_bond_radius': array(121.0) * pm})
"""
...
Bh = Element(**{'single_bond_radius': array(141.0) * pm, 'name': 'Bohrium', 'atomic_number': 107, 'symbol': 'Bh',
                'double_bond_radius': array(128.0) * pm, 'atomic_weight': 272.0, 'triple_bond_radius': array(119.0) * pm})
"""
...
Hs = Element(**{'single_bond_radius': array(134.0) * pm, 'name': 'Hassium', 'atomic_number': 108, 'symbol': 'Hs',
                'double_bond_radius': array(125.0) * pm, 'atomic_weight': 270.0, 'triple_bond_radius': array(118.0) * pm})
"""
...
Mt = Element(**{'single_bond_radius': array(129.0) * pm, 'name': 'Meitnerium', 'atomic_number': 109, 'symbol': 'Mt',
                'double_bond_radius': array(125.0) * pm, 'atomic_weight': 276.0, 'triple_bond_radius': array(113.0) * pm})
"""
