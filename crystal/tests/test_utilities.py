...
def test_periodic():
    ...
    from pylada.crystal.utilities import are_periodic_images
...
def test_into_cell():
    ...
    from pylada.crystal.utilities import are_periodic_images, into_cell
...
def test_zero_centered():
    ...
    from pylada.crystal.utilities import are_periodic_images, zero_centered
    from numpy import array, dot, all
    from numpy.linalg import inv
    from random import uniform
    cell = array([ [0, 0.5, 0.5], [0.5, 0, 0.5], [0.5, 0.5, 0] ])
...
def test_into_voronoi():
    ...
    from pylada.crystal.utilities import are_periodic_images, into_voronoi
    from numpy import array, dot
    from numpy.linalg import inv
    from random import uniform
    cell = array([ [0, 0.5, 0.5], [0.5, 0, 0.5], [0.5, 0.5, 0] ])
