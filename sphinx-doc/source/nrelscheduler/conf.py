# -*- coding: utf-8 -*-
#
# schedMain documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.pngmath', 'sphinx.ext.ifconfig', 'sphinx.ext.viewcode', 'sphinx.ext.graphviz']
...
htmlhelp_basename = 'schedMaindoc'
